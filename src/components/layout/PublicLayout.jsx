    ...
    >
      <div className="max-w-[1400px] mx-auto px-5 md:px-10 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5 group" data-testid="nav-logo">
          <div className="h-8 w-8 bg-[#134E35] grid place-items-center rounded-sm group-hover:bg-[#0D3A26] transition-colors">
        ...
        <div className="grid md:grid-cols-12 gap-10">
          <div className="md:col-span-4">
            <div className="flex items-center gap-2.5">
              <div className="h-8 w-8 bg-[#134E35] grid place-items-center rounded-sm">
                <span className="text-white font-bold text-lg leading-none">M</span>
              </div>
