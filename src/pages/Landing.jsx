...
// //   return (
// //     <div className="mt-10 relative max-w-[420px]">
// //       <div className="absolute inset-0 bg-gradient-to-r from-[#FF6A3D]/20 to-indigo-500/20 rounded-full blur-md" />
// //       <div className="relative flex items-center gap-3 bg-white/5 backdrop-blur-md px-5 py-3.5 rounded-full border border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden">
...
// //             {/* Typewriter Search Design Input */}
// //             <motion.div
// //               initial={{ opacity: 0, y: 10 }}
// //               animate={{ opacity: 1, y: 0 }}
