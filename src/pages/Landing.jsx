...
// //     "3 bhk flat for sale near me with price",
// //     "Best salon near me",
// //     "Supermarket near me"
// //   ];
...
// //     const currentFullWord = searchTerms[wordIndex];
...
// //         setIsDeleting(false);
// //         setWordIndex((prev) => (prev + 1) % searchTerms.length);
// //       } else {
...
// //   return (
// //     <div className="relative w-full min-w-[280px] sm:min-w-[340px] md:w-[360px]">
// //       {/* Soft background glow */}
// //       <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-full blur-md" />
// //       <div className="relative flex items-center gap-3 bg-[#070812]/80 backdrop-blur-md px-5 py-3.5 rounded-full border border-purple-500/60 shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden">
// //         <Search className="h-4 w-4 text-purple-400 shrink-0" />
// //         <div className="flex-1 text-[14px] font-medium text-white/90 truncate">
// //           {currentWord}
// //           <span className="animate-pulse border-r-2 border-emerald-400 ml-0.5 h-4 inline-block align-middle" />
// //         </div>
// //       </div>
// //     </div>
// //   );
...
// //                 </svg>
// //               </span>{" "}
// //               search terms your customers are looking for.
// //             </h1>
...
// //             {/* Bottom row: Stats on left, Search on right */}
// //             <div className="mt-14 border-t border-white/10 pt-8 flex flex-col xl:flex-row xl:items-center justify-between gap-8 xl:gap-6">
// //               {/* LEFT: Stats */}
...
// //                   ].map((s) => (
// //                     <div key={s.k} className="border-l border-white/15 pl-4 first:border-l-0 first:pl-0">
// //                       <div className="text-3xl md:text-[32px] font-bold text-white leading-none">
// //                         <CountUp value={s.v} prefix={s.prefix || ""} suffix={s.suffix || ""} />
// //                       </div>
// //                       <div className="mt-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-white/42 whitespace-nowrap">{s.k}</div>
// //                     </div>
// //                   ))}
// //                 </motion.div>
// //                 <motion.div
...
// //                   className="mt-5 text-[13px] sm:text-sm font-semibold text-white/58"
// //                 >
...
// //                 className="shrink-0 pb-2 xl:pb-0"
// //               >
// //                 <TypewriterSearch />
// //               </motion.div>
// //             </div>
...
//       {/* Soft background glow */}
//       <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-full blur-md" />
//       <div className="relative flex items-center gap-3 bg-white/5 backdrop-blur-md px-6 py-4 rounded-full border border-purple-500/50 shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden">
//         <Search className="h-4 w-4 text-purple-400 shrink-0" />
//         <div className="flex-1 text-[15px] font-medium text-white/90 truncate">
//           {currentWord}
//           <span className="animate-pulse border-r-2 border-emerald-400 ml-0.5 h-4 inline-block align-middle" />
//         </div>
//       </div>
...
//           {/* LEFT — Typography, CTAs, and Stats */}
//           <motion.div
//             initial={{ opacity: 0, y: 24 }}
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.7, ease: [0.25, 1, 0.5, 1] }}
...
//             {/* Animated count-up stats - Restored to original layout */}
//             <motion.div
//               initial={{ opacity: 0 }}
//               animate={{ opacity: 1 }}
//               transition={{ duration: 0.6, delay: 0.55 }}
...
//                 { v: 5, suffix: "years", k: "In business" },
//               ].map((s) => (
//                 <div key={s.k} className="border-l border-white/15 pl-4 first:border-l-0 first:pl-0 sm:first:border-l-0">
//                   <div className="text-3xl md:text-[32px] font-bold text-white leading-none">
//                     <CountUp value={s.v} prefix={s.prefix || ""} suffix={s.suffix || ""} />
//                   </div>
//                   <div className="mt-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-white/42 whitespace-nowrap">{s.k}</div>
...
//           {/* RIGHT — 3-image collage + Search Bar below */}
//           <motion.div
//             initial={{ opacity: 0, scale: 0.96 }}
//             animate={{ opacity: 1, scale: 1 }}
//             transition={{ duration: 0.9, delay: 0.15, ease: [0.25, 1, 0.5, 1] }}
...
//             <div className="relative h-[540px] md:h-[620px] w-full">
//               {/* MAIN — team image, top-right, large */}
//               <motion.div
//                 style={{ y: yImg }}
//                 className="absolute top-0 right-0 w-[78%] aspect-[4/5] rounded-sm overflow-hidden border border-white/10 shadow-[0_30px_70px_-28px_rgba(0,0,0,0.9)]"
...
//             {/* Typewriter Search Bar - Positioned directly under images */}
//             <motion.div
//               initial={{ opacity: 0, y: 15 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ duration: 0.6, delay: 0.75 }}
//               className="mt-6 z-20 w-full pl-2 sm:pl-4 lg:pl-10"
//             >
//               <TypewriterSearch />
//             </motion.div>
...
function TypewriterSearch() {
  ...
  return (
    <div className="mt-6 xl:mt-10 relative w-full max-w-[420px]">
      <div className="absolute inset-0 bg-gradient-to-r from-[#FF6A3D]/20 to-indigo-500/20 rounded-full blur-md" />
      <div className="relative flex items-center gap-3 bg-white/5 backdrop-blur-md px-4 sm:px-5 py-3 sm:py-3.5 rounded-full border border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden">
        <Search className="h-4 w-4 text-[#FF6A3D] shrink-0" />
        <div className="flex-1 text-[13px] sm:text-[14px] font-medium text-white/90 truncate">
          {currentWord}
          <span className="animate-pulse border-r-2 border-[#FF6A3D] ml-0.5 h-4 inline-block align-middle" />
        </div>
      </div>
    </div>
  );
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center gap-2 mb-6"
            >
              <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/5 border border-white/10 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.12em] text-white/80 rounded-full">
                <Award className="h-3.5 w-3.5" /> Women Achievement Summit 
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/5 border border-white/10 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.12em] text-white/75 rounded-full">
                <span className="h-1.5 w-1.5 rounded-full bg-[#FF6A3D]" /> Google Partner
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/5 border border-white/10 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.12em] text-white/75 rounded-full">
                <span className="h-1.5 w-1.5 rounded-full bg-[#FF6A3D]" /> Meta Business Partner
            ...
            <h1 className="text-4xl sm:text-[56px] lg:text-[76px] font-extrabold leading-[1.05] sm:leading-[1.02] tracking-[-0.02em] text-white">
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.25 }}
              className="mt-5 sm:mt-6 text-base sm:text-lg md:text-xl text-white/68 max-w-2xl leading-relaxed"
            >
              Performance marketing, SEO, local ranking, landing pages, creative, and offline media — one team that ships every part of your growth stack, not just a single slice of it.
            </motion.p>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.35 }}
              className="mt-8 flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-3 sm:gap-4"
            >
              <Button asChild data-testid="hero-book-call-btn" className="w-full sm:w-auto group rounded-sm bg-[#FF6A3D] hover:bg-[#E85C31] text-white h-12 px-6 text-[13px] font-semibold shadow-[0_14px_34px_-18px_rgba(255,106,61,0.75)]">
                <Link to="/contact">Book a strategy call <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" /></Link>
              </Button>
              <Button asChild variant="outline" data-testid="hero-work-btn" className="w-full sm:w-auto rounded-sm border-white/15 bg-white/5 text-white hover:bg-white/10 h-12 px-6 text-[13px] font-semibold">
                <Link to="/work">See our work <ArrowUpRight className="ml-2 h-4 w-4" /></Link>
              </Button>
              <div className="flex items-center gap-2 text-xs text-white/55 sm:ml-2 mt-2 sm:mt-0">
                <CheckCircle2 className="h-3.5 w-3.5 text-[#FF6A3D]" /> No-obligation · 30-min call
              </div>
            </motion.div>

            {/* Bottom row: Stats on left, Search on right */}
            <div className="mt-10 sm:mt-14 border-t border-white/10 pt-8 flex flex-col xl:flex-row xl:items-center justify-between gap-8 xl:gap-6">
              {/* LEFT: Stats */}
              <div className="flex-1">
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.6, delay: 0.55 }}
                  className="grid grid-cols-2 sm:flex sm:items-center gap-6 sm:gap-8"
                  data-testid="hero-stats"
                >
                  {[
                    { v: 15, suffix: "+", k: "Brands served" },
                    ...
                    <div key={s.k} className="border-l border-white/15 pl-4 first:border-l-0 first:pl-0 sm:[&:nth-child(3)]:border-l sm:[&:nth-child(3)]:pl-4 [&:nth-child(3)]:border-l-0 [&:nth-child(3)]:pl-0">
                      <div className="text-2xl sm:text-3xl md:text-[32px] font-bold text-white leading-none">
                        <CountUp value={s.v} prefix={s.prefix || ""} suffix={s.suffix || ""} />
                      </div>
                      <div className="mt-2 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.12em] text-white/42 whitespace-normal sm:whitespace-nowrap leading-tight">{s.k}</div>
                    </div>
                  ))}
                </motion.div>
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5, delay: 0.65 }}
                  className="mt-6 sm:mt-5 text-[12px] sm:text-[13px] md:text-sm font-semibold text-white/58 leading-relaxed"
                >
                  15+ brands | 98% client retention | Founded in 2020 | Rs. 10L+ monthly ad spends
                </motion.div>
              </div>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.6, delay: 0.45 }}
                className="shrink-0 pb-2 xl:pb-0 w-full xl:w-auto mt-2 xl:mt-0"
              >
                <TypewriterSearch />
              </motion.div>
            </div>
          ...
          >
            <div className="relative h-[380px] sm:h-[540px] md:h-[620px]">
              {/* MAIN — team image, top-right, large */}
              <motion.div
                style={{ y: yImg }}
                className="absolute top-0 right-0 w-[78%] aspect-[4/5] rounded-sm overflow-hidden border border-white/10 shadow-[0_30px_70px_-28px_rgba(0,0,0,0.9)]"
              >
                ...
                <div className="absolute bottom-4 right-4 bg-white/95 backdrop-blur rounded-sm px-3 py-2">
                  <div className="text-[9px] font-semibold uppercase tracking-[0.14em] text-zinc-500">The team</div>
                  <div className="text-[10px] sm:text-xs font-bold text-[#070812]">Bengaluru HQ · 22 people</div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, delay: 0.5 }}
                className="absolute bottom-6 sm:bottom-12 left-0 w-[65%] sm:w-[58%] aspect-[4/3] rounded-sm overflow-hidden border-4 border-[#070812] shadow-[0_20px_48px_-16px_rgba(0,0,0,0.75)] z-10"
              >
                <img
                  src={AWARD_PHOTO}
                  alt="Ramya Prasanna receiving the Marketing Innovation Award 2024"
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#070812]/80 via-transparent to-transparent" />
                <div className="absolute bottom-2.5 left-2 sm:left-3 right-2 sm:right-3 text-white">
                  <div className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-[0.14em] text-[#FF6A3D]">Award winner · March 2025</div>
                  <div className="text-[11px] sm:text-[13px] font-bold leading-tight mt-0.5 truncate">Ramya Prasanna · Founder</div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7, delay: 0.7 }}
                className="absolute top-2 sm:top-6 left-2 sm:-left-4 md:left-0 w-[55%] sm:w-[46%] bg-[#171829] rounded-sm p-3 sm:p-4 border border-white/10 shadow-[0_18px_45px_-18px_rgba(0,0,0,0.85)] z-20"
              >
                <div className="flex items-center gap-2">
                  <div className="h-6 w-6 sm:h-7 sm:w-7 rounded-sm bg-[#FF6A3D]/12 grid place-items-center">
                    <TrendingUp className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#FF6A3D]" />
                  </div>
                  <div className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.14em] text-white/42">Recent outcome</div>
                </div>
      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-10 relative">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            {/* Added max-sm:text-4xl to scale down purely on mobile */}
            <h2 className="max-sm:text-4xl text-[34px] sm:text-[44px] lg:text-[56px] font-extrabold leading-[1.05] tracking-[-0.02em]">
              How visible is your brand inside AI search?
            </h2>
            <p className="mt-6 text-lg text-zinc-600 leading-relaxed max-w-2xl">
              See how often ChatGPT, Perplexity, Gemini, and Claude understand, mention, and recommend your brand. The audit gives you a clear score and the gaps to fix next.
            ...
            {/* Added max-sm:grid-cols-1 so pills stack on narrow phones */}
            <div className="mt-8 grid max-sm:grid-cols-1 sm:grid-cols-3 gap-3 max-w-2xl">
              {["AI mentions", "Competitor gaps", "Content fixes"].map((item) => (
                <div key={item} className="rounded-sm border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-700 flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-[#FF6A3D] shrink-0" />
                  {item}
            ...
            {/* Added max-sm:w-full to buttons to make them tap-friendly on mobile */}
            <div className="mt-10 flex flex-wrap items-center gap-3">
              <Button asChild className="rounded-sm bg-[#FF6A3D] hover:bg-[#E85C31] text-white h-12 px-6 font-semibold max-sm:w-full">
                <Link to="/contact">Check your score for free <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
              <div className="text-sm text-zinc-500 flex items-center gap-2 max-sm:w-full max-sm:justify-center">
                <CheckCircle2 className="h-4 w-4 text-[#FF6A3D]" /> No credit card required
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white border border-zinc-200 rounded-sm overflow-hidden shadow-xl">
              ...
              <div className="p-6 md:p-8">
                <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
                  {/* Added max-sm:max-w-[220px] max-sm:mx-auto to scale the circle without touching the absolute icon positioning */}
                  <div className="relative aspect-square rounded-full border border-zinc-200 bg-white grid place-items-center shadow-inner max-sm:max-w-[220px] max-sm:mx-auto">
                    <div className="absolute inset-6 rounded-full border border-zinc-100" />
                    <div className="absolute inset-12 rounded-full border border-[#FF6A3D]/30" />
                    <Bot className="absolute top-8 right-10 h-7 w-7 text-[#FF6A3D]" />
                    <div className="text-center">
                ...
                <div className="mt-7 grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={stat.v} className="rounded-sm border border-zinc-200 bg-zinc-50 p-4 max-sm:p-3 max-sm:text-center">
                      <div className="text-2xl max-sm:text-xl font-bold text-[#070812] leading-none">{stat.k}</div>
                      <div className="mt-2 text-[10px] max-sm:text-[8px] uppercase tracking-[0.14em] text-zinc-500 leading-tight">{stat.v}</div>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-10 relative">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          <motion.div
            ...
            viewport={{ once: true, margin: "-80px" }}
            transition={{ duration: 0.8, ease: [0.25, 1, 0.5, 1] }}
            className="lg:col-span-6 relative mb-6 lg:mb-0"
          >
            <div className="relative rounded-sm overflow-hidden aspect-[4/3] md:aspect-[16/11] border-[4px] sm:border-[6px] border-white shadow-[0_40px_80px_-30px_rgba(0,0,0,0.2)]">
              <img src={AWARD_PHOTO} alt="Ramya Prasanna receiving the Marketing Innovation Award at the 2024 Women Achievements ceremony" className="absolute inset-0 w-full h-full object-cover" />
            </div>
            {/* polaroid caption - Fixed horizontal overflow */}
            <motion.div
              initial={{ opacity: 0, y: 12 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.3 }}
              className="absolute -bottom-6 right-4 sm:-right-2 md:-right-6 bg-white text-[#070812] px-4 py-3 sm:px-5 sm:py-4 rounded-sm border border-zinc-200 shadow-[0_16px_40px_-12px_rgba(0,0,0,0.1)] w-[85%] sm:max-w-xs z-10"
            >
              <div className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.16em] text-[#FF6A3D]">10 March 2025</div>
              <div className="text-sm sm:text-base font-bold leading-tight mt-1 truncate">Women Achievements Summit</div>
              <div className="text-[11px] sm:text-xs text-zinc-500 mt-0.5 truncate">Founder of Marketly — award recipient</div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-3xl sm:text-[42px] lg:text-[56px] font-extrabold leading-[1.1] sm:leading-[1.05] tracking-[-0.02em]">
              Built by a Founder who prioritizes Performance over Promises.
            </h2>
            <p className="mt-5 sm:mt-6 text-base md:text-xl text-zinc-600 leading-relaxed max-w-2xl">
              Marketly was founded by <span className="font-bold text-[#070812]">Ramya Prasanna</span> — a serial entrepreneur who saw a gap between creative marketing and actual business growth. With a background in scaling high-impact brands at Simplilearn and Scaler, she built Marketly to deliver the transparency and data-driven results that modern founders demand. Recognized for her work in Digital Innovation, she now leads a team dedicated to transforming brands through architectural precision and marketing excellence.
            </p>
            <div className="mt-8 sm:mt-10 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
              {[
                { k: "2024", v: "Agency founded" },
                { k: "15+", v: "Brands grown" },
                { k: "2025", v: "Award winner" },
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: 0.3 + i * 0.08 }}
                  className="p-4 sm:p-5 bg-white border border-zinc-200 rounded-sm shadow-sm"
                >
                  <div className="text-2xl sm:text-3xl font-extrabold text-[#FF6A3D] leading-none">{s.k}</div>
                  <div className="mt-2 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.12em] text-zinc-500">{s.v}</div>
                </motion.div>
              ))}
            </div>
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row sm:flex-wrap gap-3">
              <Button asChild className="w-full sm:w-auto rounded-sm bg-[#FF6A3D] hover:bg-[#E85C31] text-white h-12 px-6 font-semibold">
                <Link to="/contact">Talk to Ramya's team <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
              <Button asChild variant="outline" className="w-full sm:w-auto rounded-sm border-zinc-200 bg-transparent text-[#070812] hover:bg-zinc-100 h-12 px-6 font-semibold">
                <Link to="/about">Our story</Link>
              </Button>
            </div>
          </motion.div>
...
function TrustBar() {
  const logos = [...CLIENT_LOGOS, ...CLIENT_LOGOS];
  return (
    <section className="bg-[#070812] border-y border-white/10 py-12 md:py-16" data-testid="home-trust">
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        <div className="mb-10 md:mb-12">
          <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#FF6A3D] mb-4 md:mb-5 text-center">
            Certified partner · Award winner
          </div>
          <PartnerBadgeRow />
        </div>

        <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/50 mb-5 md:mb-6 text-center">
          Trusted by 50+ brands across India
        </div>
        <div className="relative overflow-hidden">
          <div className="absolute inset-y-0 left-0 w-16 md:w-24 z-10 bg-gradient-to-r from-[#070812] to-transparent pointer-events-none" />
      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-10 relative">
        <div className="grid md:grid-cols-12 gap-10 items-start">
          <div className="md:col-span-5">
            ...
            <h2 className="text-3xl sm:text-[40px] lg:text-[48px] font-extrabold leading-[1.1] sm:leading-[1.05] tracking-[-0.02em]">
              See how your site stacks up — in 60 seconds.
            </h2>
            <p className="mt-4 sm:mt-5 text-base md:text-lg text-white/70 leading-relaxed">
              A real technical + SEO audit across 20 signals — meta tags, schema, Core Web Vitals, crawl structure. PDF report lands in your inbox.
            </p>
  ...
  return (
    <section className="py-16 md:py-20 bg-[#FAFAF8] border-t border-zinc-100" data-testid="home-services">
      <div className="max-w-[1200px] mx-auto px-5 md:px-10">
        <div className="max-w-4xl mb-9">
          <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#FF6A3D] mb-4">Result-driven services</div>
          <h2 className="text-3xl sm:text-[38px] lg:text-[48px] font-extrabold leading-[1.1] sm:leading-[1.08] tracking-[-0.02em] text-[#070812]">
            Generate qualified leads and drive sales.
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-4 sm:gap-5">
          {serviceColumns.map(({ Icon, title, items }, i) => (
            <motion.div
              ...
              viewport={{ once: true, margin: "-60px" }}
              transition={{ duration: 0.5, delay: i * 0.05 }}
              className="rounded-sm border border-zinc-200 bg-white p-6 sm:p-7 md:p-8 shadow-[0_18px_45px_-36px_rgba(15,18,18,0.35)]"
            >
              <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-sm bg-[#FF6A3D]/10 grid place-items-center mb-5 sm:mb-6">
                <Icon className="h-5 w-5 text-[#FF6A3D]" />
              </div>
              <h3 className="text-lg font-bold text-[#070812] leading-tight">{title}</h3>
              <ul className="mt-4 space-y-2.5">
                {items.map((item) => (
                  <li key={item} className="flex items-start gap-2 text-sm text-zinc-600 leading-relaxed">
                    <span className="mt-1.5 sm:mt-2 h-1.5 w-1.5 rounded-full bg-[#FF6A3D] shrink-0" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
    ...
    <section className="py-20 md:py-28 bg-[#070812]" data-testid="home-certified-excellence">
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        <div className="grid md:grid-cols-12 gap-6 md:gap-8 mb-10 md:mb-14 items-end">
          <div className="md:col-span-7">
            <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#FF6A3D] mb-4">Certified excellence</div>
            <h2 className="text-3xl sm:text-[42px] lg:text-[52px] font-extrabold leading-[1.1] sm:leading-[1.05] tracking-[-0.02em] text-white">
              Platform-certified work, handled with senior discipline.
            </h2>
          </div>
          <p className="md:col-span-5 text-base md:text-lg text-white/70 leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-4 sm:gap-5">
          {cards.map((card, i) => (
            <motion.div
              ...
              viewport={{ once: true, margin: "-60px" }}
              transition={{ duration: 0.45, delay: i * 0.06 }}
              className="group bg-white/5 border border-white/10 rounded-sm p-6 sm:p-7 md:p-8 hover:border-[#FF6A3D] hover:shadow-[0_14px_36px_-22px_rgba(255,106,61,0.35)] transition-all duration-300"
            >
              <div className="flex flex-wrap items-start justify-between gap-3 sm:gap-4">
                <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-sm bg-white/5 border border-white/10 grid place-items-center p-2.5 sm:p-3">
                  {card.logo ? (
                    <img src={card.logo} alt={`${card.title} logo`} className="h-full w-full object-contain" />
                  ) : (
                    <card.Icon className="h-6 w-6 sm:h-7 sm:w-7 text-[#FF6A3D]" />
                  )}
                </div>
                <span className="inline-flex items-center gap-1.5 sm:gap-2 px-2 py-1 text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.12em] text-white/70 bg-[#070812] border border-white/10 rounded-sm mt-1">
                  <span className={`h-1.5 w-1.5 rounded-full ${card.accent}`} /> {card.status}
                </span>
              </div>
              <h3 className="mt-6 sm:mt-7 text-xl font-bold text-white leading-tight">{card.title}</h3>
              <p className="mt-3 text-[14px] sm:text-[15px] text-white/70 leading-relaxed">{card.desc}</p>
              <div className="mt-6 sm:mt-7 pt-4 sm:pt-5 border-t border-white/10 flex items-center justify-between text-xs">
                <span className="text-white/50 font-medium">Verification</span>
                <span className="font-semibold text-[#FF6A3D] flex items-center gap-1.5">
                  <CheckCircle2 className="h-3.5 w-3.5" /> Active
                </span>
...
const AWARD_IMAGES = [
  "https://ik.imagekit.io/j0xzq9pns/marktly-image/WhatsApp%20Image%202026-07-06%20at%2011.38.51%20AM.jpeg?updatedAt=1783321554375",
  "https://ik.imagekit.io/j0xzq9pns/marktly-image/WhatsApp%20Image%202026-07-06%20at%2011.34.03%20AM.jpeg?updatedAt=1783321554261",
  "https://ik.imagekit.io/j0xzq9pns/marktly-image/WhatsApp%20Image%202026-07-06%20at%2011.34.40%20AM.jpeg?updatedAt=1783321554052",
  "https://ik.imagekit.io/j0xzq9pns/marktly-image/WhatsApp%20Image%202026-07-06%20at%2011.38.38%20AM.jpeg?updatedAt=1783321552691",
];
...
function AwardsSection() {
  ...
  return (
    <section id="awards" className="py-20 bg-[#070812] border-t border-white/8 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-5 md:px-10 mb-8 md:mb-12">
        <Intro
          tag="Recognition & Awards"
          title="Milestones & Moments."
          sub="Celebrating excellence and building meaningful connections with our partners."
      ...
      <div className="relative w-full flex overflow-hidden">
        <div className="absolute top-0 bottom-0 left-0 w-12 md:w-32 bg-gradient-to-r from-[#070812] to-transparent z-10 pointer-events-none" />
        <div className="absolute top-0 bottom-0 right-0 w-12 md:w-32 bg-gradient-to-l from-[#070812] to-transparent z-10 pointer-events-none" />
      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          <motion.div
            ...
            viewport={{ once: true, margin: "-80px" }}
            transition={{ duration: 0.6 }}
            className="lg:col-span-5 bg-[#070812] text-white rounded-sm p-6 sm:p-8 md:p-10 relative overflow-hidden min-h-[380px] sm:min-h-[420px] flex flex-col justify-between"
          >
            <div className="absolute inset-0 opacity-[0.06]" style={{backgroundImage: "radial-gradient(circle, white 1px, transparent 1px)", backgroundSize: "28px 28px"}} />
            <div className="relative">
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#FF6A3D] mb-4 sm:mb-5">Marketly tech</div>
              <h2 className="text-3xl sm:text-[42px] lg:text-[52px] font-extrabold leading-[1.1] sm:leading-[1.05] tracking-[-0.02em]">
                Mobile apps and product systems.
              </h2>
              <p className="mt-4 sm:mt-5 text-base md:text-lg text-white/70 leading-relaxed">
                Custom tools for teams that need more than a website: dashboards, apps, CRMs and workflow systems that keep operations moving.
            ...
            <div className="relative mt-8 sm:mt-10 grid grid-cols-3 gap-2 sm:gap-3">
              {[
                { k: "04", v: "product lines" },
                { k: "UI", v: "tracking flows" },
                { k: "App", v: "mobile ready" },
              ].map((stat) => (
                <div key={stat.v} className="border border-white/10 bg-white/[0.035] p-3 sm:p-4 rounded-sm text-center sm:text-left">
                  <div className="text-xl sm:text-2xl font-extrabold text-[#FF6A3D]">{stat.k}</div>
                  <div className="mt-1 sm:mt-2 text-[9px] sm:text-[10px] uppercase tracking-[0.14em] text-white/45">{stat.v}</div>
                </div>
              ))}
            </div>
          </motion.div>

          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4 mt-2 lg:mt-0">
            {products.map(({ Icon, title, text }, i) => (
              <motion.div
                key={title}
                initial={{ opacity: 0, y: 18 }}
                ...
                viewport={{ once: true, margin: "-60px" }}
                transition={{ duration: 0.5, delay: i * 0.06 }}
                className="group bg-zinc-50 border border-zinc-200 rounded-sm p-6 sm:p-7 hover:bg-white hover:border-[#FF6A3D] hover:shadow-[0_18px_44px_-26px_rgba(255,106,61,0.32)] transition-all duration-300"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-sm bg-white border border-zinc-200 grid place-items-center group-hover:border-[#FF6A3D]/25 shrink-0">
                    <Icon className="h-4 w-4 sm:h-5 sm:w-5 text-[#FF6A3D]" />
                  </div>
                  <div className="text-[9px] sm:text-[10px] uppercase tracking-[0.14em] font-semibold text-zinc-400 text-right mt-1">{products[i].meta}</div>
                </div>
                <h3 className="mt-6 sm:mt-7 text-lg sm:text-xl font-bold text-[#070812] leading-tight">{title}</h3>
                <p className="mt-3 text-sm text-zinc-600 leading-relaxed">{text}</p>
                <div className="mt-6 h-px bg-zinc-200" />
                <div className="mt-4 flex items-center gap-2 text-xs font-semibold text-[#FF6A3D]">
                  Product build <ArrowRight className="h-3.5 w-3.5" />
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden bg-[#0A0D14]">
                  <img
                    ...
                    className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.04]"
                  />
                  <div className="absolute top-4 left-4 pr-4 flex flex-wrap gap-1.5">
                    {c.tags.slice(0, 2).map((t) => (
                      <span key={t} className="px-2.5 py-1 text-[9px] sm:text-[10px] font-semibold uppercase tracking-wider bg-white/10 text-white rounded-sm">
                        {t}
                      </span>
                    ))}
                  </div>
                ...
                <div className="p-6 md:p-8">
                  <div className="flex items-center gap-2 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.15em] text-[#FF6A3D]">
                    Case Study · {c.industry}
                  </div>
                  <h3 className="mt-3 text-lg sm:text-xl md:text-2xl font-bold text-white leading-tight">{c.client}</h3>
                  <div className="mt-3 flex items-baseline gap-2 sm:gap-3">
                    <span className="text-3xl md:text-4xl font-extrabold text-[#FF6A3D] leading-none">{c.heroMetric}</span>
                    <span className="text-xs sm:text-sm text-white/70">{c.heroMetricLabel}</span>
                  </div>
                  <p className="mt-3 text-[14px] sm:text-[15px] text-white/70 leading-relaxed line-clamp-2">{c.summary}</p>
                  <div className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-[#FF6A3D] group-hover:gap-3 transition-all">
                    Read case study <ArrowRight className="h-4 w-4" />
                  </div>
                </div>
...
function GrowthProofDeck() {
  ...
  return (
    <section className="bg-white border-y border-zinc-200" data-testid="home-growth-proof-deck">
      <div className="py-20 md:py-28 bg-zinc-50">
        <div className="max-w-[1400px] mx-auto px-5 md:px-10">
          <div className="space-y-6 sm:space-y-8">
            ...
            >
              <div className="grid lg:grid-cols-12 gap-px bg-zinc-200">
                <div className="lg:col-span-4 bg-white p-6 sm:p-7 md:p-9 flex flex-col justify-between">
                  <div>
                    <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#FF6A3D]">Featured campaign videos</div>
                    <h2 className="mt-3 text-2xl sm:text-3xl md:text-[44px] font-extrabold leading-tight text-[#070812]">
                      KSPL powered by KSSCA 2024
                    </h2>
                  ...
                  <div className="mt-6 sm:mt-8 grid gap-3">
                    {[
                      ...
                      <div key={item.k} className="rounded-sm border border-zinc-200 bg-zinc-50 p-4">
                        <div className="text-sm font-extrabold text-[#FF6A3D]">{item.k}</div>
                        <div className="mt-1 sm:mt-2 text-xs leading-relaxed text-zinc-600">{item.v}</div>
                      </div>
                    ))}
                  </div>
                </div>

                <div className="lg:col-span-8 bg-[#070812] text-white p-4 sm:p-5 md:p-6 relative overflow-hidden">
                  <div className="absolute inset-0 opacity-[0.07]" style={{backgroundImage: "radial-gradient(circle, white 1px, transparent 1px)", backgroundSize: "18px 18px"}} />
                  <div className="relative">
                    <div className="relative aspect-video overflow-hidden rounded-sm border border-white/10 bg-black shadow-[0_20px_50px_-28px_rgba(0,0,0,0.9)]">
                      <video
                        ...
                        preload="metadata"
                      />
                      <div className="absolute inset-x-0 top-0 p-3 sm:p-4 bg-gradient-to-b from-black/65 to-transparent">
                        <div className="inline-flex items-center gap-2 rounded-full bg-white/12 px-3 py-1.5 text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.16em] text-white backdrop-blur">
                          <span className="h-1.5 w-1.5 rounded-full bg-[#FF6A3D]" /> Featured video {activeVideoIndex + 1}
                        </div>
                      </div>
                      {!videoPlaying && (
                        <button
                          ...
                          aria-label="Play featured KSPL video"
                        >
                          <span className="h-12 w-12 sm:h-16 sm:w-16 rounded-full bg-[#FF6A3D] text-white grid place-items-center shadow-[0_18px_35px_-18px_rgba(0,0,0,0.8)]">
                      ...
                      <div className="absolute inset-x-0 bottom-0 p-3 sm:p-4 bg-gradient-to-t from-black/75 to-transparent">
                        <div className="flex items-center justify-between gap-3">
                          <button
                            type="button"
                            onClick={toggleFeaturedVideo}
                            className="inline-flex items-center gap-2 rounded-full bg-white text-[#070812] px-3 sm:px-4 py-1.5 sm:py-2 text-[10px] sm:text-xs font-bold hover:bg-[#F4F8F1] transition-colors"
                          >
                            {videoPlaying ? <Pause className="h-3 w-3 sm:h-3.5 sm:w-3.5" /> : <Play className="h-3 w-3 sm:h-3.5 sm:w-3.5 fill-current" />}
                            {videoPlaying ? "Pause" : "Play"}
                          </button>
                          <button
                            type="button"
                            onClick={toggleFeaturedAudio}
                            className="h-8 w-8 sm:h-9 sm:w-9 rounded-full border border-white/20 bg-white/10 grid place-items-center text-white backdrop-blur hover:bg-white/20 transition-colors"
                            aria-label={videoMuted ? "Turn sound on" : "Turn sound off"}
                          >
                            {videoMuted ? <VolumeX className="h-3.5 w-3.5 sm:h-4 sm:w-4" /> : <Volume2 className="h-3.5 w-3.5 sm:h-4 sm:w-4" />}
                          </button>
                        </div>
                      </div>
                    </div>
                      ...
                      {ksplVideos.map((src, index) => (
                        ...
                        >
                          <div className="relative aspect-video overflow-hidden rounded-sm bg-black">
                            ...
                            />
                            <div className="absolute inset-0 grid place-items-center bg-black/20">
                              <span className="h-6 w-6 sm:h-8 sm:w-8 rounded-full bg-white/90 text-[#070812] grid place-items-center">
                                <Play className="h-2.5 w-2.5 sm:h-3.5 sm:w-3.5 fill-current ml-0.5" />
                              </span>
                            </div>
                          </div>
                          <div className="mt-1 sm:mt-1.5 text-center text-[9px] sm:text-[10px] font-semibold text-white/60">Video {index + 1}</div>
                        </button>
                      ))}
                    </div>
                  </div>
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4">
                {automationLogos.map((logo) => (
                  <div
                    key={logo.name}
                    className="h-12 sm:h-14 w-[120px] sm:w-[150px] md:w-[168px] rounded-sm bg-zinc-50 px-3 sm:px-4 flex items-center justify-center hover:bg-white hover:shadow-[0_12px_28px_-24px_rgba(15,18,18,0.45)] transition-all"
                  >
                    <img
                      src={logo.src}
                      alt={`${logo.name} logo`}
            ...
            >
              {deckCards.map(({ Icon, title, text, stat }) => (
                <div key={title} className="bg-white border border-zinc-200 rounded-sm p-5 sm:min-h-[220px]">
                  <div className="flex items-center justify-between gap-3">
                    <div className="h-10 w-10 rounded-sm bg-[#FF6A3D]/10 grid place-items-center">
                      <Icon className="h-4 w-4 text-[#FF6A3D]" />
                    </div>
                    <div className="text-[9px] sm:text-[10px] uppercase tracking-[0.14em] font-bold text-[#FF6A3D]">{stat}</div>
                  </div>
                  <h4 className="mt-5 sm:mt-6 text-lg font-bold leading-tight text-[#070812]">{title}</h4>
                  <p className="mt-3 text-sm text-zinc-600 leading-relaxed">{text}</p>
                </div>
              ))}
            </motion.div>
      ...
      <div className="py-16 md:py-20 bg-white">
        <div className="w-full relative overflow-hidden group border-y border-zinc-200 bg-zinc-200">
          <div className="absolute inset-y-0 left-0 w-12 sm:w-20 md:w-48 z-10 bg-gradient-to-r from-white to-transparent pointer-events-none" />
          <div className="absolute inset-y-0 right-0 w-12 sm:w-20 md:w-48 z-10 bg-gradient-to-l from-white to-transparent pointer-events-none" />

          <div className="flex w-max gap-px animate-marquee group-hover:[animation-play-state:paused]">
            {[...reviewPlatforms, ...reviewPlatforms, ...reviewPlatforms].map((platform, index) => (
              <div key={`${platform.name}-${index}`} className="bg-white py-5 sm:py-6 md:py-7 px-6 sm:px-8 text-center w-[160px] sm:w-[180px] md:w-[240px] shrink-0">
                <div className={`font-extrabold text-base sm:text-lg md:text-xl ${platform.tone}`}>{platform.name}</div>
                <div className="mt-2 flex justify-center gap-1 text-[#F5A623]">
                  {[...Array(5)].map((_, i) => <Star key={i} className="h-3.5 w-3.5 sm:h-4 sm:w-4 fill-current" />)}
                </div>
                <div className="mt-1.5 text-[9px] sm:text-[11px] font-semibold text-zinc-500 uppercase tracking-wide">
                  {platform.score}/5 · {platform.sub}
                </div>
              </div>
            ))}
      ...
      <div className="py-20 md:py-28 bg-[#070812] text-white relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-5 md:px-10 relative">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-14 items-start">
            <div className="lg:col-span-5">
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#FF6A3D] mb-4">Result-driven services</div>
              <h2 className="text-3xl sm:text-[32px] md:text-[48px] font-extrabold leading-tight">
                Generate qualified leads and drive sales.
              </h2>
            ...
            <div className="lg:col-span-7 grid md:grid-cols-3 gap-px bg-white/10 border border-white/10">
              {serviceColumns.map(({ Icon, title, items }) => (
                <div key={title} className="bg-[#0A0D14] p-6 sm:p-7">
                  <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-sm bg-white/5 border border-white/10 grid place-items-center mb-5 sm:mb-6">
                    <Icon className="h-5 w-5 text-[#FF6A3D]" />
                  </div>
          ...
          <div className="mt-10 sm:mt-12 overflow-x-auto snap-x snap-mandatory pb-4 [-ms-overflow-style:none] [scrollbar-width:none]">
            <div className="flex gap-4 min-w-max">
              {deckCards.map(({ Icon, title, text, stat }) => (
                <div key={title} className="snap-start w-[85vw] sm:w-[420px] rounded-sm border border-white/10 bg-white/[0.035] p-5 sm:p-6">
                  <div className="flex items-center justify-between">
                    <Icon className="h-5 w-5 text-[#FF6A3D]" />
                    <span className="text-[10px] uppercase tracking-[0.16em] font-bold text-white/40">{stat}</span>
                  </div>
                  <h3 className="mt-6 sm:mt-8 text-xl sm:text-2xl font-extrabold leading-tight">{title}</h3>
                  <p className="mt-3 sm:mt-4 text-sm text-white/60 leading-relaxed">{text}</p>
                </div>
              ))}
            </div>
          </div>
    ...
    <section className="py-20 md:py-28 bg-white" data-testid="home-why">
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        <div className="max-w-3xl mb-10 md:mb-14">
          <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#FF6A3D] mb-4">Why Marketly</div>
          <h2 className="text-3xl sm:text-[42px] lg:text-[52px] font-extrabold leading-[1.1] sm:leading-[1.05] tracking-[-0.02em] text-[#070812]">
            Clients stay, because the boring stuff gets done.
          </h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
          {points.map((p, i) => (
            ...
            >
              <div className="text-sm font-mono font-semibold text-[#FF6A3D]">{p.n}</div>
              <h3 className="mt-4 sm:mt-5 text-lg font-bold text-[#070812] leading-tight">{p.t}</h3>
              <p className="mt-2.5 text-[14px] sm:text-[15px] text-zinc-600 leading-relaxed">{p.d}</p>
            </motion.div>
          ))}
        </div>
      </div>
    ...
    <section className="bg-[#FF6A3D] text-white" data-testid="home-growth-cta">
      <div className="max-w-[1200px] mx-auto px-5 md:px-10 py-8 md:py-9">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
          <div>
            <h2 className="text-2xl md:text-[28px] font-extrabold leading-tight">Ready to compound your growth?</h2>
            <p className="mt-1.5 sm:mt-1 text-sm md:text-base text-white/85 font-semibold">No obligation - 30-min strategy call - Senior team, not juniors</p>
          </div>
          <Button asChild className="w-full md:w-auto rounded-sm bg-white text-[#070812] hover:bg-white/90 h-12 px-6 text-sm font-bold self-start md:self-center">
            <Link to="/contact">Book a call <ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
        </div>
      </div>
      <div className="h-4 sm:h-6 bg-[#E85C31]" />
    </section>
  );
}
  ...
  return (
    <section className="py-20 md:py-28 bg-zinc-50" data-testid="home-testimonials">
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {TESTIMONIALS.slice(0, 2).map((t) => (
            <div key={t.name} className="p-6 sm:p-8 md:p-10 bg-white rounded-sm border border-zinc-200">
              <div className="flex items-center gap-1 mb-4 sm:mb-5 text-[#FF6A3D]">
                {[...Array(5)].map((_, i) => <Star key={i} className="h-3.5 w-3.5 sm:h-4 sm:w-4 fill-current" />)}
              </div>
              <blockquote className="text-[17px] sm:text-lg md:text-[19px] text-[#070812] leading-relaxed sm:leading-snug font-medium">
                "{t.quote}"
              </blockquote>
              <div className="mt-6 pt-6 border-t border-zinc-200 flex items-center gap-3 sm:gap-4">
                <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-full bg-[#070812] text-white font-bold grid place-items-center shrink-0">{t.initial}</div>
                <div>
                  <div className="font-bold text-[#070812] text-sm sm:text-base">{t.name}</div>
                  <div className="text-xs sm:text-sm text-zinc-500">{t.title}</div>
                </div>
              </div>
            </div>
          ))}
...
function FinalCTA() {
  return (
    <section className="py-20 md:py-28 bg-[#070812] text-white relative overflow-hidden" data-testid="home-final-cta">
      <div className="absolute top-0 right-0 w-full sm:w-1/2 h-full opacity-10 sm:opacity-20 pointer-events-none" style={{backgroundImage: "radial-gradient(circle at top right, #FF6A3D 0%, transparent 70%)"}} />
      <div className="max-w-[1400px] mx-auto px-5 md:px-10 relative">
        <div className="max-w-3xl">
          <h2 className="text-3xl sm:text-[44px] lg:text-[56px] font-extrabold leading-[1.1] sm:leading-[1.05] tracking-[-0.02em]">
            Tell us where you want to go. We'll map the route.
          </h2>
          <p className="mt-5 sm:mt-6 text-base sm:text-lg text-white/80 max-w-xl leading-relaxed">
            Free 30-minute strategy call. We'll audit your current setup, tell you the 2–3 levers that will move fastest, and you decide if we're the right fit.
          </p>
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row sm:items-center gap-3">
            <Button asChild data-testid="final-cta-btn" className="w-full sm:w-auto rounded-sm bg-[#FF6A3D] hover:bg-[#E85C31] text-white h-12 px-6 font-semibold">
              <Link to="/contact">Book a strategy call <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
            <Button asChild variant="outline" className="w-full sm:w-auto rounded-sm border-white/30 bg-transparent text-white hover:bg-white/10 h-12 px-6 font-semibold">
              <Link to="/work">See our work</Link>
            </Button>
          </div>
        </div>
